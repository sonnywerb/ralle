...
4. RALL-E.exe will be installed in C:\Users\<user>\AppData\Local\RALL-E

> **Note:** if you have a version older than 1.1.0 already installed, uninstall it first
> (Settings > Apps > RALL-E > Uninstall) before installing the new version. Versions
...
## Usage
- Run RALL-E.exe to start the program
- There will be a system tray icon present if it's running
- To stop the program: right click on the icon > Exit
